...
light_pos, green_duration, red_duration, start_red = [5, 15], [10, 5], [5, 10], [False, True]
"""
...
r = rule.MaxVelocityTrafficLights(road_length, max_velocity, light_pos, green_duration, red_duration, start_red)
...
visualiser.matrix_plot(traffic_evolution, light_pos, green_duration, red_duration, start_red)
